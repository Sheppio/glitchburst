...
export class HordeEngine {
   ...
   */
  adopt(snapshots: Iterable<{ id: EnemyId; x: number; y: number; kind: EnemyKind; hp: number }>, wave: number): void {
    this.enemies.clear();
    let highest = 0;
  ...
  private spawnAt(kind: EnemyKind, x: number, y: number): Enemy | null {
