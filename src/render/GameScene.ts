...
export class GameScene extends Phaser.Scene {
  ...
  private outboundEvents: ReturnType<typeof decodeEvents> = [];
  ...
  override update(_time: number, delta: number): void {
    ...
    if (this.horde) this.hostTick(dt, delta);
    else this.peerTick(delta);
   ...
   */
  private hostTick(dt: number, deltaMs: number): void {
    ...
    if (this.hordeAccumulator < interval) return;
   ...
   */
  private peerTick(deltaMs: number): void {
