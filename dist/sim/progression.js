...
export const UPGRADE_ORDER = ['damage', 'speed', 'firerate', 'regen', 'vitality'];
...
export class PlayerProgress {
    ...
    totalChips = 0;
    stacks = { damage: 0, speed: 0, firerate: 0, regen: 0, vitality: 0 };
    /**
    ...
    isMaxed(id) {
        if (id === 'vitality')
            return this.maxHealth >= PROGRESSION.healthCeiling;
